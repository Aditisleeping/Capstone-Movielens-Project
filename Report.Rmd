---
title: 'HarvardX: PH125.9x Data Science:  MovieLens Rating Prediction Project'
...
We will display the first few rows of the edx subset, in order to become familiar with the dataset.
There are 6 columns: 'userId','movieId','genre','rating','title' and 'timestamp'.
Each row represents a single rating of a user for a given movie.
